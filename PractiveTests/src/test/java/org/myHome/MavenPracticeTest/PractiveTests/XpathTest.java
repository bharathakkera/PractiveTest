...
public class XpathTest {
	...
	public static WebElement myTextElement;

	@Test
	 public static void XpathTestMethod() throws Exception{
	...
	System.setProperty("webdriver.chrome.driver","C://Selenium//chromedriver.exe");
	 ...
	 Thread.sleep(5000);
	 //myTextElement = driver.findElement(By.name("Email*"));
	 myTextElement = driver.findElement(By.xpath("span[@class='RveJvd snByac']/span"));
	 myTextElement.click(); */
		...
		driver.findElement(By.xpath("//input[@type = 'email']")).sendKeys("bharath.akkera@gmail.com");
		// Enter Password
